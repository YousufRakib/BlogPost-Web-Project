...
public partial class SuperAdmin_Profile : System.Web.UI.Page
{
    ...
    public void deatil()
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            lblProfession.Text = ddlProfession.SelectedItem.Text;
    ...
    protected void btnSeeBlogg_Click(object sender, EventArgs e)
    {
        Response.Redirect("BloggList.aspx?uId=" + hdnUserId.Value);
    }
}