<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="SuperAdminMaster" %>
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <p class="mb-1">
                                ...
                                <asp:LinkButton ID="lnkRegistration" Visible="false" Font-Underline="true" OnClick="lnkRegistration_Click" runat="server">Here</asp:LinkButton>
                            </p>
