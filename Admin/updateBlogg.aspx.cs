...
public partial class Admin_updateBlogg : System.Web.UI.Page
{
    ...
    public void deatil()
    {
        ...
        SqlDataAdapter da = new SqlDataAdapter("select * from Blogg where createUserId = '" + Session["UserID"].ToString() + "' and BloggId='" + hdnbId.Value + "'", con);
        ...
        for (int i = 0; i < fileCollection.Count; i++)
        {
            ...
            if (uploadfile.ContentLength > 0)
            {
             ...
             + " where BloggId='" + hdnbId.Value + "'";
                ...
                string query = "update Blogg set  BloggImage='" + fullPath + "' where createUserId='" + hdnUserID.Value + "' and BloggId='" + hdnbId.Value + "'";
