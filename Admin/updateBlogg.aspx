<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="updateBlogg.aspx.cs" Inherits="Admin_updateBlogg" %>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlStatus" runat="server" class="form-control">
                                          ...
                                          <asp:Label ID="lblStatus" Visible="false" ReadOnly="true"  class="form-control" runat="server" Text=""></asp:Label>
